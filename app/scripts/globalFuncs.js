...
globalFuncs.HDWallet = {
    ...
    hwAbassianPath: "m/44'/68'/0'/0", // first address: m/44'/68'/0'/0/0
...
globalFuncs.getWalletPath = function(
    ...
    if (walletType === "ledger") {
        switch (nodeType) {
            ...
            case nodes.nodeTypes.BNA:
                return globalFuncs.HDWallet.hwAbassianPath;
